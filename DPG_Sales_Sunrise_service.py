"""Service for DPG - Sales & Sunrise â€“ microservice simulator. Called by IDP-Cloud-CG, calls CCSF downstream."""
import os
import time
import random
...
SERVICE_NAME = "DPG - Sales & Sunrise"
PORT = int(os.getenv("SERVICE_DPG_SALES_SUNRISE_PORT", 8023))
...
@app.route("/dpg-sales-sunrise", methods=["GET"])
def handle_dpg_sales_sunrise():
    ...
    try:
        ...
        with tracer.start_as_current_span("process-request") as span:
            ...
            db_result = simulate_db_call(tracer, "db_dpg_sales_sunrise")
