"""Service for CCMULE â€“ microservice simulator. Called by CCSF, calls IDP-Cloud-CG downstream."""
import os
import time
import random
...
SERVICE_NAME = "CCMULE"
PORT = int(os.getenv("SERVICE_CCMULE_PORT", 8021))
...
def handle_ccmule():
    ...
    try:
        ...
        with tracer.start_as_current_span("process-request") as span:
            ...
            db_result = simulate_db_call(tracer, "db_ccmule")
