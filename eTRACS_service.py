"""Service for eTRACS â€“ leaf microservice simulator. Called by Platform Support ATTFEDGOV1, no downstream calls."""
import os
import time
import random
...
SERVICE_NAME = "eTRACS"
PORT = int(os.getenv("SERVICE_ETRACS_PORT", 8025))
...
def handle_etracs():
    ...
    try:
        ...
        with tracer.start_as_current_span("process-request") as span:
            ...
            db_result = simulate_db_call(tracer, "db_etracs")
