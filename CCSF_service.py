"""Service for CCSF â€“ entry microservice simulator. Starts the custom chain for Lookup Customer."""
import os
import time
import random
...
SERVICE_NAME = "CCSF"
PORT = int(os.getenv("SERVICE_CCSF_PORT", 8020))
OTLP_ENDPOINT = os.getenv("OTEL_EXPORTER_OTLP_ENDPOINT", "localhost:4317")
E2EUX = "Lookup Customer"
...
def handle_ccsf():
    ...
    try:
        ...
        with tracer.start_as_current_span("process-request") as span:
            ...
            db_result = simulate_db_call(tracer, "db_ccsf")
