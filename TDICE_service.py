"""TDICE â€“ leaf microservice simulator. No downstream calls."""
import os
import time
import random
...
SERVICE_NAME = "TDICE"
PORT = int(os.getenv("TDICE_PORT", 8012))
