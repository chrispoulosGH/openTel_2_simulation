"""Service for CCM â€“ microservice simulator. Called by CCSF, calls CCMULE downstream."""
import os
import time
import random
...
SERVICE_NAME = "CCM"
PORT = int(os.getenv("SERVICE_CCM_PORT", 8012))
OTLP_ENDPOINT = os.getenv("OTEL_EXPORTER_OTLP_ENDPOINT", "localhost:4317")
E2EUX = os.getenv("E2EUX", "Lookup Customer")
Business_Flow_ID = "broadband_ticket_id_0001"
    ...
    try:
        ...
        with tracer.start_as_current_span("process-request") as span:
            copy_baggage_to_span(
                ["E2EUX", "chain_id", "Business_Flow_ID"],
                span=span,
                fallback_values={
                    "E2EUX": E2EUX,
                    "chain_id": chain_id,
            ...
            db_result = simulate_db_call(tracer, "db_ccm")
