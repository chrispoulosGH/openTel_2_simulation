"""SHM â€“ leaf microservice simulator. No downstream calls."""
import os
import time
import random
...
SERVICE_NAME = "SHM"
PORT = int(os.getenv("SHM_PORT", 8011))
