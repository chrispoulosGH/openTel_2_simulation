"""Service C â€“ microservice simulator. Called by A, calls F downstream."""
import os
import time
import random
...
def handle_c():
    ...
    with tracer.start_as_current_span("process-request") as span:
        ...
        time.sleep(random.uniform(0.005, 0.015))  # simulate payload parsing
        db_result = simulate_db_call(tracer, "db_c")
        time.sleep(random.uniform(0.008, 0.03))  # simulate business logic
