"""Service for IDP-Cloud-CG â€“ microservice simulator. Called by CCMULE, calls DPG - Sales & Sunrise downstream."""
import os
import time
import random
...
SERVICE_NAME = "IDP-Cloud-CG"
PORT = int(os.getenv("SERVICE_IDP_CLOUD_CG_PORT", 8022))
...
@app.route("/idp-cloud-cg", methods=["GET"])
def handle_idp_cloud_cg():
    ...
    try:
        ...
        with tracer.start_as_current_span("process-request") as span:
            ...
            db_result = simulate_db_call(tracer, "db_idp_cloud_cg")
